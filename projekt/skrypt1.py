...
def dodaj_poczatkowe_kina():
    poczatkowe_kina = [
        {"nazwa": "Kino Pieroga", "lokalizacja": "Warszawa"},
        {"nazwa": "Kino Cebularz", "lokalizacja": "Lublin"},
        {"nazwa": "Kino Obwarzanek", "lokalizacja": "Kraków"},
        {"nazwa": "Kino Krasnoludek", "lokalizacja": "Wrocław"}
    ]
...
button_dodaj_kino.grid(row=3, column=1, columnspan=2)
